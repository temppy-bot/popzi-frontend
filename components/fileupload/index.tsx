...
const FileUpload: React.FC<FileUploadProps> = ({ onUpload }) => {
  ...
  return (
    <div className="w-full h-[480px]">
      <div
        {...getRootProps()}
        className={`flex flex-col items-center gap-4 justify-center w-full h-full border-2 border-dotted rounded-lg p-4 ${isDragActive ? 'border-blue-400' : 'border-gray-300'
          }`}
      >
        <input {...getInputProps()} />
        <Image
