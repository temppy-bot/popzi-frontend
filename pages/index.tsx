...
export default function Home() {
  ...
  const handleIsExpand = useCallback(
    () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row  w-full justify-between gap-3">
        <div className={` ${isExpand ? "md:w-full" : "md:w-[60%]"}  w-full `}>
          <Tiptap isExpand={isExpand} handleIsExpand={handleIsExpand} />
        </div>
        {
          !isExpand && <div className="md:w-[40%] w-full">
            <FileUpload onUpload={() => { }} />
          </div>
        }
      </div>
